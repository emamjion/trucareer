...
const careerArticles = [
  {
    ...
    excerpt: "Learn the essential strategies for successful salary negotiations and get the compensation you deserve.",
    category: "Salary",
    readTime: "5 min read",
  ...
  },
  {
    ...
    excerpt: "Get insider tips on how to ace your next job interview and make a lasting impression on employers.",
    category: "Interview",
    readTime: "6 min read",
    image: "/placeholder.svg?height=200&width=300",
...
const careerTips = [
  ...
  },
  {
    ...
    description: "Stay relevant in your field by learning new technologies and developing in-demand skills.",
  },
  {
    icon: Users,
    title: "Build Meaningful Relationships",
    description: "Cultivate professional relationships that can provide mentorship and career opportunities.",
  },
  {
    icon: BookOpen,
    title: "Stay Industry Informed",
    description: "Keep up with industry trends and news to make informed career decisions.",
  },
]
  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4">
        ...
        {/* Latest Articles */}
        <div className="mb-12">
          <h3 className="text-2xl font-bold text-center mb-8">Latest Career Articles</h3>
